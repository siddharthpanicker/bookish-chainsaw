...
{{- define "imply.dataTier1.fullname.headless" -}}
{{- printf "%s-data-headless" (include "imply.fullname" .) -}}
{{- end -}}

{{- define "imply.dataTier2.fullname.headless" -}}
{{- printf "%s-data-two-headless" (include "imply.fullname" .) -}}
{{- end -}}

{{- define "imply.dataTier3.fullname.headless" -}}
{{- printf "%s-data-three-headless" (include "imply.fullname" .) -}}
{{- end -}}
